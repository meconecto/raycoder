...
The `1.0.0-rc.5` candidate adds durable conversational planning, structured SPEC and ticket revisions, recoverable generation sessions, confirmed DAG creation, and an atomic user-local installer with update, rollback, and conservative uninstall.
...
version. npm versions cannot be renamed, so this promotes `1.0.0-rc.5` to the stable channel
