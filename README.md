...
The `1.0.0-rc.6` candidate adds durable conversational planning, structured SPEC and ticket revisions, recoverable generation sessions, confirmed DAG creation, and an atomic user-local installer with update, rollback, and conservative uninstall.
