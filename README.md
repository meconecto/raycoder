...
The `1.0.0-rc.7` candidate adds an actionable bilingual UI, durable workspace preparation and multistack verification, conversational planning, confirmed DAG creation, and an atomic user-local installer with update, rollback, and conservative uninstall.
